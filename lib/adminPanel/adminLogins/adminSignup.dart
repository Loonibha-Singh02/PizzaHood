...
class _SignUpPageState extends State<AdminSignUpPage> {
  ...
  final TextEditingController adfullController = TextEditingController();
                        ...
                        child: Column(
                          children: [
                            ...
                            MyTextField(
                              ...
                              controller: adconfirmPasswordController,
                              validator: (value) {
                                if (value == null || value.isEmpty) {
                                  return 'Please confirm your password';
                                }
                                if (value != adpasswordController.text) {
  ...
  void _adsignUp() async {
    String fullName = adfullController.text;
    String email = ademailController.text;

    User? user = await _auth.signUpWithEmailAndPassword(
      ademailController.text,
      adpasswordController.text,
    );
